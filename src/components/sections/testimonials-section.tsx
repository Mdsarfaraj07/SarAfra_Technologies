...
const testimonials = [
  {
    ...
    author: 'Alex P.',
    title: 'CEO, TechCorp',
    avatar: { initial: 'A', src: 'https://res.cloudinary.com/dazw9kv1l/image/upload/v1722872366/man_face_jqnfj8.png', hint: 'man face' },
  },
  {
    ...
    avatar: { initial: 'M', src: 'https://res.cloudinary.com/dazw9kv1l/image/upload/v1722872366/woman_face_plp9p3.png', hint: 'woman face' },
  },
  {
    ...
    avatar: { initial: 'D', src: 'https://res.cloudinary.com/dazw9kv1l/image/upload/v1722872366/professional_face_q8gfbd.png', hint: 'professional face' },
  },
];
